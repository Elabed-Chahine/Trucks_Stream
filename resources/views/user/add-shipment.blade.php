...
<div class="py-5 px-6">
    <main class="max-w-2xl mx-auto mt-10 bg-gray-100 border border-gray-200 p-6 rounded-xl">
        <div class=" text-2xl items-center colour-blue-500">
            <h1 class="text-black">ADD new SHIPMENT</h1>
        </div>
    <form method="POST" action="/user/shipments" class="mt-10" enctype="multipart/form-data">
        @csrf
        ...
        <div class="mb-6">
            ...
            <textarea name="description" id="description" cols="30" rows="10" class="block mb-2 uppercase font-bold text-xs border border-gray-400 w-full text-gray-700"></textarea>
